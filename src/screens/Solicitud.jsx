    ...
    return (
        ...
        <div className="formulario">
            ...
            <select id="tipo_organizacion" onChange={handleTipoOrgChange}>
                ...
                <option value="Cooperativa de trabajo asociado">Cooperativa de trabajo asociado</option>
                <option value="Cooperativa multiactiva">Cooperativa multiactiva</option>
